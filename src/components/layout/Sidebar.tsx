...
{ to: '/gestion-comercial', icon: Trophy, label: 'Gestión Comercial' },
  ...
  <motion.aside
    ...
    className={cn(
      ...
      <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto min-h-0">
        ...
        {/* Plataforma IA */}
        {!isCollapsed &&
      <p className="text-[10px] font-semibold uppercase tracking-wider text-violet-500/70 px-3 mt-4 mb-1">MÓDULOS
      </p>}
